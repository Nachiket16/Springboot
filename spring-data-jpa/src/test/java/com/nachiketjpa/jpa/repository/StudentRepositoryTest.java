...
//                .guardianMobile("12312312312")
    ...
    public void printGetStudentByEmailAddress(){
        Student student = studentRepository.getStudentByEmailAddress("nachiket@gmail.com");
        System.out.println("student = " + student);
    }

    @Test
    public void printGetStudentFirstNameByEmailAddress() {
        String firstNameByEmailAddress = studentRepository.getStudentFirstNameByEmailAddress("nachiket@gmail.com");
        System.out.println("firstNameByEmailAddress = " + firstNameByEmailAddress);
    }

    @Test
    void getStudentByEmailAddressNative() {
        Student student = studentRepository.getStudentByEmailAddressNative("nachiket@gmail.com");
        System.out.println("student = " + student);
    }

    @Test
    void getStudentByEmailAddressNativeNamedParam() {
        Student student = studentRepository.getStudentByEmailAddressNativeNamedParam("nachiket@gmail.com");
        System.out.println("student = " + student);
    }

    @Test
    void updateStudentNameByEmailId() {
        int updatedColumn = studentRepository.updateStudentNameByEmailId("Shivam", "shiva@kailash.com");
        System.out.println("updatedColumn = " + updatedColumn);
    }
}